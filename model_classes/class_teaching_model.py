# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 17:09:06 2019
...
#-------------------------
from class_Data import Splitted_Data
#-------------------------
import config
#-------------------------
import logging
...
#         loss_tensor_category = category_tensor[:,0,:]
#         loss_tensor_category = loss_tensor_category.type('torch.LongTensor')
#         print(loss_tensor_output)
#         print(loss_tensor_category)
#     #    loss = criterion(loss_tensor_output, loss_tensor_category)
#         print('dupa11', torch.max(loss_tensor_category , 1)[1])
#         loss = criterion(loss_tensor_output, torch.max(loss_tensor_category , 1)[1])   
#         return loss
# =============================================================================
...
# =============================================================================
#     def train(self, rnn):
#         partial_train = partial(self.train_one_dataloader, rnn)
#         for iter in range(epochs):
#             dataloader = DataLoader(self._transformed_data, batch_size = self._batch_size, shuffle=True, num_workers=0)
#             for i_batch, sample_batched in enumerate(dataloader):
#                 partial_train(sample_batched['trajectory_category'], sample_batched['trajectory_in_numpy'])
# =============================================================================
